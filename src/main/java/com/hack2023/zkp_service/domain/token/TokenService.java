...
public class TokenService {
    ...
    public String generateChallengeToken(String email, List<Integer> indicesToHash, int totalRounds) throws RuntimeException {
        return generateChallengeToken(email, indicesToHash, totalRounds, 0);
    }

    public String generateChallengeToken(String email, List<Integer> indicesToHash, int totalRounds, int round) throws RuntimeException {
        try {
